...
const table = ({ selectedMonth }: any) => {
  ...
  return (
    <>
      ...
      <div className="text-4xl font-bold text-center">Product Management</div>
...
import Sales_Products_Update from "@/components/MainFunctions/sales/update/Sales_Products_Update"
      ...
      <Dialog>
        ...
        <DialogContent>
          <div>
            ...
            <Sales_Products_Update currentData={updateId}/>
          </div>
        </DialogContent>
      </Dialog>
    </>
