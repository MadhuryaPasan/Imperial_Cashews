...
import { quality_end_product_check_createNew } from "@/utils/quality/quality_end_product_check"; // API
import {
  Card,
  CardContent,
  CardDescription,
...
const quality_end_product_check_Insert = () => {
  // Get current timestamp
  const currentTimestamp = new Date();

  // insert data
  const CreateDoc: SubmitHandler<any> = async (data) => {
    await quality_end_product_check_createNew(data);
    // wait for 1 seconds
...
export default quality_end_product_check_Insert;