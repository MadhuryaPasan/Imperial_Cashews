...
export async function Sales_Customer_GetAll() {
    try {
...
export async function Sales_Customer_Delete(id: string) {
    try {
...
export async function Sales_Customer_Add(data: any) {
    try {
        // console.log(data);
...
export async function Sales_Customer_GetOne(id: string) {
    try {
...
export function Sales_Customer_ReturnAll(){
  ...
  useEffect(() => {
    async function getAll() {
      try {
        let result = await Sales_Customer_GetAll();
        setData(result);
      } catch (error) {
