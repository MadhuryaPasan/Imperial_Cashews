...
export async function Inventory_FinalProduct_GetAll() {
    try {
        const response = await axios.get(`${URL}${URL_COLLECTION}`);
        return response.data;
    } catch (error) {
        console.error("Error fetching all final product entries:", error);
        throw error;
    }
}

export async function Inventory_FinalProduct_Delete(id: string) {
    try {
...
export async function Inventory_FinalProduct_Add(data: any) {
    try {
        // console.log(data);
...
export async function Inventory_FinalProduct_Update(id: string, data: any) {
    try {
...
export async function Inventory_FinalProduct_GetOne(id: string) {
    try {
...
export function Inventory_FinalProduct_ReturnAll(){
  ...
  useEffect(() => {
    async function getAll() {
      try {
        let result = await Inventory_FinalProduct_GetAll();
        setData(result);
      } catch (error) {
