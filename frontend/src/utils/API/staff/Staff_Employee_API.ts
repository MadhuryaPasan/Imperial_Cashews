...
export async function Staff_Employee_GetAll() {
    try {
...
export async function Staff_Employee_Delete(id: string) {
    try {
...
export async function Staff_Employee_Add(data: any) {
    try {
        // console.log(data);
...
export async function Staff_Employee_Update(id: string, data: any) {
    try {
...
export async function Staff_Employee_GetOne(id: string) {
    try {
...
export function Staff_Employee_ReturnAll(){
  ...
  useEffect(() => {
    async function getAll() {
      try {
        let result = await Staff_Employee_GetAll();
        setData(result);
      } catch (error) {
