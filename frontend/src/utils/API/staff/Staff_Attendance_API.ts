...
const URL_COLLECTION = "/Staff_Attendance";

export async function Staff_Attendance_GetAll() {
    try {
...
export async function Staff_Attendance_Delete(id: string) {
    try {
...
export async function Staff_Attendance_Add(data: any) {
    try {
        // console.log(data);
...
export async function Staff_Attendance_Update(id: string, data: any) {
    try {
...
export async function Staff_Attendance_GetOne(id: string) {
    try {
...
export function Staff_Attendance_ReturnAll() {
    ...
    useEffect(() => {
        async function getAll() {
            try {
                let result = await Staff_Attendance_GetAll();
                setData(result);
            } catch (error) {
