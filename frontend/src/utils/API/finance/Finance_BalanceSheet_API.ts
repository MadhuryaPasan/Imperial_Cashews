...
export async function Finance_BalanceSheet_GetAll() {
    try {
...
export async function Finance_BalanceSheet_Delete(id: string) {
    try {
...
export async function Finance_BalanceSheet_Add(data: any) {
    try {
        // console.log(data);
...
export async function Finance_BalanceSheet_Update(id: string, data: any) {
    try {
...
export async function Finance_BalanceSheet_GetOne(id: string) {
    try {
...
export function Finance_BalanceSheet_ReturnAll(){
  ...
  useEffect(() => {
    async function getAll() {
      try {
        let result = await Finance_BalanceSheet_GetAll();
        // console.log(result);
        setData(result);
      } catch (error) {
...
export async function Finance_BalanceSheet_auto() {
    try {
        // console.log(data);
        const response = await axios.post(`${URL}/Finance_BalanceSheet_Auto` );
        // console.log(data);
        // console.log(response);
        return response;
    } catch (error) {
