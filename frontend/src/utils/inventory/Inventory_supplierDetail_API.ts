...
{/*export async function Inventory_supplierDetail_getAllData() {
    try {
...
export async function Inventory_supplierDetail_getDoc(id: string) {
...
export async function Inventory_supplierDetail_createNew(data: any) {
...
export async function Inventory_supplierDetail_updateDoc(id: string, data: any) {
