...
export async function Inventory_FinalProduct_deleteDoc(id: string) {
    const response = await axios.delete(`${URL}${URL_COLLECTION}/${id}`);
    alert("Document deleted successfully");
    return response;
}

export async function Inventory_FinalProduct_createNew(data: any) {
...
export async function Inventory_FinalProduct_updateDoc(id: string, data: any) {
