...
export async function createNew_Sales_Sales(data:any){
    console.log(data);
...
export async function Sales_Sales_updateDoc(id:string,data:any){
    const response = await axios.put(`${URL}${URL_COLLECTION}/${id}`,data);
    alert("Document updated successfully");
    return response;
}

export async function Sales_Sales_getDoc(id:string){
