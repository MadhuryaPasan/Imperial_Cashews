...
const dashboard = () => {
  return (
    ...
    <div className="relative mx-auto flex h-screen w-screen flex-col items-center  justify-center overflow-hidden rounded-3xl">
      <Card className="z-20 relative flex h-fit w-[800px] max-sm:h-100 max-sm:w-100 items-center justify-center overflow-hidden rounded-2xl  shadow-xl backdrop-blur-md  bg-white/50  ">
        <CardContent>
        <div className="flex h-40 w-40 mx-auto">
                  <Logo />
                </div>
      ...
      <ThreeDMarquee
        className="pointer-events-none absolute inset-0 h-screen w-screen opacity-30 blur-[3px] "
        images={images}
      />
    </div>
  );
